<nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center"
    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            {{-- @guest
            <li class="nav-item d-lg-block d-sm-block">
                <a class="nav-link" href="{{ route('landing.login.page') }}"><i data-feather="log-in" style="height: 1.5rem; width: 1.5rem;"></i></a>
            </li>
            @endguest --}}
            ...
            @auth
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">{{ $authenticated_user_data->na_karyawan ?: 'Girl Friend :)' }}</span>
                            <span class="user-status">{{ $authenticated_user_data->daftar_login->type ?: 'Pemuda Pancasila :P' }}</span></div><span class="avatar"><img
                                class="round"
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                        ...
                        <a class="dropdown-item" href="{{ route('landing.logout.redirect') }}"><i class="mr-50"
    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-dark navbar-shadow menu-border"
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand"
                        href="{{ env('APP_URL') }}"><span class="brand-logo">
                            <svg viewbox="0 0 139 95" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" height="24">
                                <defs>
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item" data-menu="menu"><a
                        class="nav-link d-flex align-items-center" href="{{ env('APP_URL') }}"><i data-feather="home"></i><span
                            data-i18n="Home">Home</span></a>
                </li>
                @auth
                <li class="nav-item" data-menu="menu"><a
                        class="nav-link d-flex align-items-center" href="{{ route('userPanels.dashboard') }}"><i data-feather="command"></i><span
                            data-i18n="Dashboards">Dashboards</span></a>
                </li>
                @endauth
                <li class="dropdown nav-item" data-menu="dropdown"><a
                        class="dropdown-toggle nav-link d-flex align-items-center" href="#"
                        data-toggle="dropdown"><i data-feather="package"></i><span
                            data-i18n="Help">Help</span></a>
                    <ul class="dropdown-menu">
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center" data-toggle="modal" data-target="#contactUsModal"
                                data-toggle="dropdown" data-i18n="Email"><i data-feather="mail"></i><span
                                    data-i18n="ContactUS">ContactUS</span></a>
                        </li>
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center" data-toggle="modal" data-target="#aboutUsModal"
                                data-toggle="dropdown" data-i18n="Chat"><i data-feather="message-square"></i><span
                                    data-i18n="AboutUS">AboutUS</span></a>
                        </li>
